...
//for this project you will need : Arduino (i am using the mega2560) , ultrasonic sensor (hc-sr04 is used in here) , 16x4 lcd display , led , buzzer 
...
void setup()
{
  ...
  //i chose the distance to be 100cm=5800/58 you can change it if you want
